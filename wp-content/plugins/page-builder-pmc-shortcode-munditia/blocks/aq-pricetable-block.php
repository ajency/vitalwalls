		...
		function block($instance) {
			...
			$output = '<div class="aq-pricetable-wrapper '.$style.' '.$color.' cf">';
				$output .= '<ul class="aq-pricetable-items">';
					...
					$output .= '<li class="fa aq-pricetable-item aq-pricetable-title"><h3 class="title">'.htmlspecialchars_decode($title).'</h3>';
					...
					foreach($features as $feature) {
						$output .= '<li class="fa aq-pricetable-item">'.do_shortcode(htmlspecialchars_decode($feature)).'</li>';
					}
