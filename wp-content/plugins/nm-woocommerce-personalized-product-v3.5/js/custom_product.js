...
if(isVariable ==1)
{
    ...
    var target = document.getElementById('pa_size');
    var size_popup = document.getElementById('pa_size_popup');
...
function onload()
{
    ...
    {
        var frame = document.getElementById('frames');
        var value = document.getElementById('pa_size').value;
        /*if(value!=null)
        {
        jQuery("#size option[value='"+value+"']").prop("selected", false);
        }*/

        var selectedSize = jQuery(".variations #pa_size").val();
...
function jsFunction()
{
    ...
    for (i=1;i<mylen;  i++) {
        ...
        var escapedseq = document.getElementById('pa_size').value;
    ...
    for (var i = 0; i<myarray.length; i++){
        ...
        var price_val = parseFloat(price[1]).toFixed(2);
...
{
    var sizeMain = document.getElementById('pa_size');
    var size_popup = document.getElementById('pa_size_popup');
    var size_popup_val = document.getElementById('pa_size_popup').value;
  ...
  //  alert(sizeMain.value);
   // alert(size_popup.value);
    ...
    //Set main size dropdown same as  pop up's size dropdown
     sizeMain.value = size_popup.value;
    //jQuery("#size option[value='"+size_popup_val+"']").prop("selected", true);
    ...
    if(document.getElementById('pa_size_popup').value=="")
    {
    ...
    for (i=1;i<mylen;  i++) {
        ...
        var escapedseq = document.getElementById('pa_size_popup').value;
        escapedseq = escapedseq.replace(/[^A-Z]/ig, ""); //retrieve size value
