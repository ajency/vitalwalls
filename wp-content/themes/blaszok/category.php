	...
	<div id="mpcth_main_container">
		...
		<div id="mpcth_content_wrap">
			<header id="mpcth_archive_header">
				<h3 id="mpcth_archive_title" class="mpcth-deco-header"><span><?php echo __('Archives for ', 'mpcth') . '<em class="mpcth-color-main-color">' . single_cat_title('', false) . '</em>'; ?></span></h3>

				<?php if (category_description()) { ?>
					<div id="mpcth_archive_description"><?php echo category_description(); ?></div>
				<?php } ?>
			</header>
