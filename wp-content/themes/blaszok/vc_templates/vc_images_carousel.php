...
$i = -1;
$css_class =  apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_images_carousel wpb_content_element'.$el_class.' clearfix'.($brands ? ' mpcth-brands ' : ''), $this->settings['base']);
