...
$css_anim_class = $this->getCSSAnimation($css_animation);

// $style = $this->buildStyle($bg_image, $bg_color, $bg_image_repeat, $font_color, $padding, $margin_bottom);
$style_wrap = $this->buildStyle('', $bg_color, '', $font_color, $padding, $margin_bottom);
$style_image = $this->buildStyle($bg_image, '', $bg_image_repeat);
