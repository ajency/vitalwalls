			...
			<div id="color-selector">
                ...
                <?php if ( $product->product_type == 'variable' ) : ?>
                    ...
                    foreach($available_variations as $availVar){
                        ...
                        if($available_variations[$i]['attributes']['attribute_size']=="small")
                        {
                            $sizeVariationsArr['small'] = $available_variations[$i]['price_html'];
                        }
                        else if($available_variations[$i]['attributes']['attribute_size']=="medium")
                        {
                            $sizeVariationsArr['medium'] = $available_variations[$i]['price_html'];
                        }
                        else if($available_variations[$i]['attributes']['attribute_size']=="large")
                        {
		...
		<script type="text/javascript">
            ...
            jQuery(document).ready(function(){
               ...
               /* jQuery('select[name=attribute_size] option:eq(1)').attr('selected', 'selected');
                ...
                if(isVariable ==1)
                {
                    jQuery('#size option:first').hide();
                    jQuery('#size_popup option:first').hide();
