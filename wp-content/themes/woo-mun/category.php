...
<div class="mainwrap blog">
	<div class="main clearfix">
		...
		<div class="content blog">
			...
			<div class = "blog <?php if(is_sticky(get_the_id())) echo ' sticky' ?>">
				<?php
					...
					<?php else : ?>
						...
						<div class="postcontent">
							<div class="post-not-found">
								<div class="icon-src-big"><i class="fa fa-search fa-3x"></i></div>
								<h1><?php _e('Sorry there are no posts to be found','wp-munditia'); ?></h1>
								<div class="posttext">
									<a href="<?php echo home_url(); ?>"><?php _e('Return to home page','wp-munditia'); ?></a>
								</div>
							</div>
						</div>
