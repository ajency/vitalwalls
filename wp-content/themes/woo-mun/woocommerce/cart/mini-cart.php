...
?>	
				<ul class="cart_list product_list_widget  ">
					...
					<?php $count1 = 0;
						...
						<?php $count1= $count1 + $actual_price;
					...
					<?php else : ?>
						...
						<li class="fa empty cart"><?php _e('No products in the cart.', 'woocommerce'); ?></li>

					<?php endif; ?>
				<?php if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) : ?>
						<p class="total top"><strong><?php _e('Subtotal', 'woocommerce'); ?>:&#8377; </strong><?php echo $count1 ;?></p>
