...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-munditia'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','wp-munditia'),
		'last_text' => __('Last &raquo;','wp-munditia'),
		'next_text' => __('&raquo;','wp-munditia'),
		'prev_text' => __('&laquo;','wp-munditia'),
		'dotright_text' => __('...','wp-munditia'),
		'dotleft_text' => __('...','wp-munditia'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
