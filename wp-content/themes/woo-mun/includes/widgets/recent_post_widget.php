...
class recent_posts extends WP_Widget {
	function recent_posts() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recent_posts', 'description' => 'Displays the post image and title.'.'wp-munditia' );



		/* Create the widget. */
		$this->WP_Widget( 'recent_posts-widget', __('Munditia - Premium Recent Posts', 'wp-munditia'), $widget_ops, '' );
	}
