...
jQuery(document).ready(function($) {
	...
	$('input.of-input[data-fun=toggle]').change(function() {
		...
		if($this.attr('checked') == 'checked') {
			$this.parents('.mpcth-of-section').siblings('.' + on_class).slideDown();
			$this.parents('.mpcth-of-section').siblings('.' + off_class).slideUp();
		} else {
			$this.parents('.mpcth-of-section').siblings('.' + off_class).slideDown();
			$this.parents('.mpcth-of-section').siblings('.' + on_class).slideUp();
		}
	});
